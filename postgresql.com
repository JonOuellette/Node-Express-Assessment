...
<html lang="en">
 <head>
  ...
  <meta property="article:published_time" content="2023-11-18T23:38:29.440638" />
    ...
    <div class="col-lg-5">
      <div class="sidebar">
        ...
        <ul class="divided">
            ...
            <li>
              <h3><a href="/about/news/pgpool-ii-45-beta1-is-now-released-2751/">Pgpool-II 4.5 beta1 is now released.</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-11-18 by Pgpool Global Development Group</li>
              </ul>
            </li>
          
            <li>
              <h3><a href="/about/news/wiltondb-33-released-2750/">WiltonDB 3.3 released</a></h3>
              <ul class="meta">
                <li><i class="far fa-clock"></i>&nbsp;2023-11-15 by WiltonDB Software</li>
              </ul>
            </li>
     ...
     <!-- First Column First Row Planet PostgreSQL -->
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6cc"> Experiencing WAL REDO in PostgreSQL</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;David Z</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-18</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6ca"> Explore Table Access Method Capabilities: Sequential Scan Analyzed</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;cary huang</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-17</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6cb"> An Introduction to Indexing and Partitioning in PostgreSQL</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c7"> Transaction Block Isolation Levels</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c8"> Postgres + Citus + Partman, Your IoT Database</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c5"> TRAKTOR, protection for tables in a replicaset</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Ernst-Georg Schmid</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-16</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c9"> Teach Kelvin Your Thing (TKTY) — High Performance PostgreSQL for Rails 🖥️</a></h3>
            <ul class="meta">
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c4"> LATERAL Usage</a></h3>
            <ul class="meta">
              <li><i class="far fa-comments"></i>&nbsp;Bruce Momjian</li>
              <li><i class="far fa-clock"></i>&nbsp;2023-11-15</li>
            </ul>
          </div>
        </div>
        ...
        <div class="col-md-4">
          <div class="text-center">
            <h3><a href="https://postgr.es/p/6c3"> Database Concurrency: Two phase Locking (2PL) to MVCC – Part 2</a></h3>
            <ul class="meta">
